...
// Axmol spec: disable char8_t
// ------------------------------------------------------------
// Reason:
//   - char8_t introduces unnecessary type fragmentation.
//   - std::string (char-based) is already the de facto UTF-8 container.
//   - Forcing char8_t breaks compatibility with existing libraries,
//     adds cognitive overhead, and wastes developer resources globally.
//   - UTF-8 is the universal standard; no need for a redundant type.
// Conclusion:
//   Axmol treats UTF-8 as std::string/char only.
//   char8_t is considered meaningless and is explicitly disabled.
