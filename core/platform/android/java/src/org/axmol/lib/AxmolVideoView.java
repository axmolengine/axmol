...
public class AxmolVideoView extends SurfaceView implements MediaPlayerControl {
    private String TAG = "AxmolVideoView";
    ...
    public AxmolVideoView(AxmolActivity activity,int tag) {
        super(activity);
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mIsAssetRouse) {
                ...
                if (afd == null && AxmolEngine.getObbFile() != null) {
                    afd = AxmolEngine.getObbFile() .getAssetFileDescriptor(mVideoFilePath);
                }
