...
public class AxysVideoView extends SurfaceView implements MediaPlayerControl {
    private String TAG = "AxysVideoView";
    ...
    protected AxysActivity mAxysActivity = null;
    ...
    public AxysVideoView(AxysActivity activity,int tag) {
        super(activity);
        
        mViewTag = tag;
        mAxysActivity = activity;
        initVideoView();
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mIsAssetRouse) {
                AssetFileDescriptor afd = mAxysActivity.getAssets().openFd(mVideoFilePath);
                if (afd == null && AxysHelper.getObbFile() != null) {
                    afd = AxysHelper.getObbFile() .getAssetFileDescriptor(mVideoFilePath);
                }
                mMediaPlayer.setDataSource(afd.getFileDescriptor(),afd.getStartOffset(),afd.getLength());
            } else {
                mMediaPlayer.setDataSource(mAxysActivity, mVideoUri);
            }
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                Resources r = mAxysActivity.getResources();
                int messageId;
                ...
                new AlertDialog.Builder(mAxysActivity)
