...
void MathUtil::transformVertices(V3F_T2F_C4B* dst, const V3F_T2F_C4B* src, size_t count, const Mat4& transform)
{
    // Check some assumptions made by optimizations
    static_assert(sizeof(V3F_T2F_C4B) == 24);
    static_assert(offsetof(V3F_T2F_C4B, position) == 0);
    static_assert(offsetof(V3F_T2F_C4B, texCoord) == 12);
    static_assert(offsetof(V3F_T2F_C4B, color) == 20);
#if defined(AX_SSE_INTRINSICS)
