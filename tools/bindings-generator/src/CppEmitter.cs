...
internal static class CppEmitter
{
    ...
    private static void AppendGeneratedHeader(StringBuilder text)
    {
        text.AppendLine("/****************************************************************************");
        text.AppendLine(" Copyright (c) 2019-present Simdsoft Limited.");
        text.AppendLine();
        text.AppendLine(" https://axmol.dev/");
        text.AppendLine();
