...
# ----------------------------------------------------------------------------
'''
"compile" plugin for adxe command line tool
'''
...
class CCPluginCompile(adxe.CCPlugin):
    """
    compiles a project
    """
    ...
    def check_param(self, value, default_value, available_values, error_msg, ignore_case=True):
        ...
        if check_value in right_values:
            ...
            raise adxe.CCPluginError(error_msg, adxe.CCPluginError.ERROR_WRONG_ARGS)
    ...
    def _update_build_cfg(self):
        ...
        try:
            ...
            if key_of_copy is not None:
                if adxe.dict_contains(cfg_info, key_of_copy):
            ...
            if key_of_must_copy is not None:
                if adxe.dict_contains(cfg_info, key_of_must_copy):
