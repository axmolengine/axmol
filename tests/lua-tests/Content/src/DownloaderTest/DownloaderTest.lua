...
local function DownloaderLayer()
    ...
    local downloader = ax.Downloader.new()
    ...
    local function init()
        ...
        local labelGet  = ax.Label:createWithTTF("Test Download Image", s_arialPath, 22)
        ...
        local labelPost = ax.Label:createWithTTF("Test Download File Not Exists", s_arialPath, 22)
