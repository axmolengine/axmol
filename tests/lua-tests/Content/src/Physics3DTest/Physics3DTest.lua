...
function Physics3DTestDemo:shootBox(des)
    ...
    local sprite = cc.PhysicsSprite3D:create("MeshRendererTest/box.c3t", rbDes)
...
function BasicPhysics3DDemo:extend()
    ...
    local floor = cc.PhysicsSprite3D:create("MeshRendererTest/box.c3t", rbDes)
...
function Physics3DConstraintDemo:extend()
    ...
    sprite = cc.Sprite3D:create("MeshRendererTest/box.c3t")
    ...
    for k = 1,ARRAY_SIZE_Y do
        for i = 1,ARRAY_SIZE_X do
            for j = 1,ARRAY_SIZE_Z do
                ...
                local sprite = cc.PhysicsSprite3D:create("MeshRendererTest/sphere.c3b", rbDes)
                sprite:setTexture("MeshRendererTest/plane.png")
                sprite:setCameraMask(cc.CameraFlag.USER1)
...
function Physics3DCollisionCallbackDemo:extend()
    ...
    local scale = 2.0
    local trianglesList = cc.Bundle3D:getTrianglesList("MeshRendererTest/boss.c3b")
    ...
    local sprite = cc.Sprite3D:create("MeshRendererTest/boss.c3b")
    sprite:addComponent(component)
