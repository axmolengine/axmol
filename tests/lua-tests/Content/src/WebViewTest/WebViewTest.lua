...
function WebViewTest:init()
    ...
    local urlTextField = axui.InputField:create("Input a URL here", "Arial", 20)
    ...
    local httpLabel = axui.Text:create("https:// ", "Arial", 20)
    ...
    local resetBtn = axui.Button:create("cocosui/animationbuttonnormal.png", "cocosui/animationbuttonpressed.png")
    resetBtn:setTitleText("Visit URL")
    resetBtn:setPosition(canvasSize.width / 2 + 80 , canvasSize.height / 2 + self._webView:getContentSize().height / 2 + resetBtn:getContentSize().height / 2 + 10)
    ...
    local reloadBtn = axui.Button:create("cocosui/animationbuttonnormal.png", "cocosui/animationbuttonpressed.png")
    reloadBtn:setTitleText("Reload")
    reloadBtn:setPosition(canvasSize.width / 2 + self._webView:getContentSize().width / 2 + reloadBtn:getContentSize().width / 2 + 10, canvasSize.height / 2 + 50)
    reloadBtn:addClickEventListener(function(sender)
        self._webView:reload()
    end)
    self:addChild(reloadBtn)

    local forwardBtn = axui.Button:create("cocosui/animationbuttonnormal.png","cocosui/animationbuttonpressed.png")
    forwardBtn:setTitleText("Forward")
    forwardBtn:setPosition(canvasSize.width / 2 + self._webView:getContentSize().width / 2 + forwardBtn:getContentSize().width / 2 + 10,canvasSize.height / 2)
    forwardBtn:addClickEventListener(function(sender)
        self._webView:goForward()
    end)
    self:addChild(forwardBtn)

    local backBtn = axui.Button:create("cocosui/animationbuttonnormal.png", "cocosui/animationbuttonpressed.png")
    backBtn:setTitleText("Back")
    backBtn:setPosition(canvasSize.width / 2 + self._webView:getContentSize().width/2 + backBtn:getContentSize().width/2 + 10, canvasSize.height - 50)
    backBtn:addClickEventListener(function(sender)
        self._webView:goBack()
    end)
    self:addChild(backBtn)

    local loadFileBtn = axui.Button:create("cocosui/animationbuttonnormal.png", "cocosui/animationbuttonpressed.png")
    loadFileBtn:setTitleText("Load FILE")
    loadFileBtn:setPosition(canvasSize.width / 2 - self._webView:getContentSize().width/2 - loadFileBtn:getContentSize().width/2 - 30, canvasSize.height / 2 + 50)
    loadFileBtn:addClickEventListener(function(sender)
        self._webView:loadFile("Test.html")
    end)
    self:addChild(loadFileBtn)

    local loadHTMLBtn = axui.Button:create("cocosui/animationbuttonnormal.png","cocosui/animationbuttonpressed.png")
    loadHTMLBtn:setTitleText("Load Data")
    loadHTMLBtn:setPosition(canvasSize.width / 2 - self._webView:getContentSize().width/2 - loadHTMLBtn:getContentSize().width/2 - 30, canvasSize.height / 2)
    ...
    local evalJsBtn = axui.Button:create("cocosui/animationbuttonnormal.png", "cocosui/animationbuttonpressed.png")
    evalJsBtn:setTitleText("Evaluate JS")
    evalJsBtn:setPosition(canvasSize.width / 2 - self._webView:getContentSize().width/2 - evalJsBtn:getContentSize().width/2 - 30, canvasSize.height / 2 - 50)
