...
TouchManager::TouchManager()
    : lastX(0), lastY(0), lastX1(0), lastY1(0), lastX2(0), lastY2(0), lastTouchDist(0), deltaX(0), deltaY(0), scale(1)
{}
...
void TouchManager::touchesMoved(ax::Point touches[], int num)
{
    ...
    if (minDist2 > 70 * 70 * 2 && num > 2)
        return;  // 処理しない
    // pt2に一番近い点
    ax::Point pt1 = touches[index1];
    ax::Point pt2 = touches[index2];
