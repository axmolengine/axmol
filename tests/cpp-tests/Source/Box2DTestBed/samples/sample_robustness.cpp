...
{
public:
    explicit HighMassRatio1(Settings& settings) : Sample(settings)
    {
    ...
    static Sample* Create(Settings& settings) { return new HighMassRatio1(settings); }
};
...
{
public:
    explicit HighMassRatio2(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new HighMassRatio2(settings); }
};
...
{
public:
    explicit HighMassRatio3(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 16.5f};
    ...
    static Sample* Create(Settings& settings) { return new HighMassRatio3(settings); }
};
...
{
public:
    explicit OverlapRecovery(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    ~OverlapRecovery() override { free(m_bodyIds); }
    ...
    static Sample* Create(Settings& settings) { return new OverlapRecovery(settings); }
...
{
public:
    explicit TinyPyramid(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new TinyPyramid(settings); }
