...
{
public:
    explicit SingleBox(Settings& settings) : Sample(settings)
    {
    ...
    static Sample* Create(Settings& settings) { return new SingleBox(settings); }
...
{
public:
    explicit TiltedStack(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new TiltedStack(settings); }
...
public:
    ...
    explicit VerticalStack(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new VerticalStack(settings); }
...
public:
    ...
    explicit CircleStack(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new CircleStack(settings); }
...
public:
    ...
    explicit CapsuleStack(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new CapsuleStack(settings); }
};
...
{
public:
    explicit Cliff(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Cliff(settings); }
...
{
public:
    explicit Arch(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Arch(settings); }
};
...
{
public:
    explicit DoubleDomino(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new DoubleDomino(settings); }
};
...
{
public:
    explicit Confined(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Confined(settings); }
...
{
public:
    explicit CardHouse(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new CardHouse(settings); }
};
