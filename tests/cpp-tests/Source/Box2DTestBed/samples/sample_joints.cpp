...
public:
    ...
    explicit DistanceJoint(Settings& settings) : Sample(settings)
    {
    ...
    static Sample* Create(Settings& settings) { return new DistanceJoint(settings); }
...
{
public:
    explicit MotorJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new MotorJoint(settings); }
...
{
public:
    explicit FilterJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 7.0f};
    ...
    static Sample* Create(Settings& settings) { return new FilterJoint(settings); }
};
...
{
public:
    explicit RevoluteJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new RevoluteJoint(settings); }
...
{
public:
    explicit PrismaticJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new PrismaticJoint(settings); }
...
{
public:
    explicit WheelJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new WheelJoint(settings); }
...
{
public:
    explicit Bridge(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Bridge(settings); }
...
{
public:
    explicit BallAndChain(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, -8.0f};
    ...
    static Sample* Create(Settings& settings) { return new BallAndChain(settings); }
...
public:
    ...
    explicit Cantilever(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Cantilever(settings); }
...
public:
    ...
    explicit FixedRotation(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 8.0f};
    ...
    static Sample* Create(Settings& settings) { return new FixedRotation(settings); }
...
public:
    ...
    explicit BreakableJoint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 8.0f};
    ...
    static Sample* Create(Settings& settings) { return new BreakableJoint(settings); }
...
{
public:
    explicit UserConstraint(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new UserConstraint(settings); }
...
{
public:
    explicit Driving(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Driving(settings); }
...
{
public:
    explicit Ragdoll(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 12.0f};
    ...
    void Spawn()
    {
        CreateHuman(&m_human, m_worldId, {0.0f, 25.0f}, 1.0f, m_jointFrictionTorque, m_jointHertz, m_jointDampingRatio,
                    1, nullptr, false);
    ...
    static Sample* Create(Settings& settings) { return new Ragdoll(settings); }
...
{
public:
    explicit SoftBody(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new SoftBody(settings); }
...
{
public:
    explicit DoohickeyFarm(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new DoohickeyFarm(settings); }
};
...
{
public:
    explicit ScissorLift(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new ScissorLift(settings); }
...
{
public:
    explicit GearLift(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
        ...
        b2BodyId groundId;
        {
            ...
            const char* path =
                ...
                "-2.64584,-1e-5 v -2.64583 h -2.64583 v -2.64584 h -2.64584 v -2.64583 H 111.125 v -2.64583 h -2.64583 "
                "v "
                "-2.64583 h -2.64583 v -2.64584 l -2.64584,1e-5 v -2.64583 l -2.64583,-1e-5 V 174.625 h -2.645834 v "
                "-2.64584 l "
...

        {
            ...
            {
                b2Polygon tooth =
                    b2MakeOffsetRoundedBox(toothHalfWidth, toothHalfHeight, center, rotation, toothRadius);
    ...
    static Sample* Create(Settings& settings) { return new GearLift(settings); }
