...
public:
    ...
    explicit BounceHouse(Settings& settings) : Sample(settings)
    {
    ...
    static Sample* Create(Settings& settings) { return new BounceHouse(settings); }
...
{
public:
    explicit BounceHumans(Settings& settings) : Sample(settings)
    {
        g_camera.m_center = {0.0f, 0.0f};
    ...
    static Sample* Create(Settings& settings) { return new BounceHumans(settings); }
...
{
public:
    explicit ChainDrop(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 0.0f};
    ...
    static Sample* Create(Settings& settings) { return new ChainDrop(settings); }
...
{
public:
    explicit ChainSlide(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new ChainSlide(settings); }
};
...
{
public:
    explicit SegmentSlide(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 10.0f};
    ...
    static Sample* Create(Settings& settings) { return new SegmentSlide(settings); }
};
...
{
public:
    explicit SkinnyBox(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new SkinnyBox(settings); }
...
public:
    ...
    explicit GhostBumps(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new GhostBumps(settings); }
...
{
public:
    explicit SpeculativeFallback(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {1.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new SpeculativeFallback(settings); }
};

static int sampleSpeculativeFallback =
    RegisterSample("Continuous", "Speculative Fallback", SpeculativeFallback::Create);

class SpeculativeSliver : public Sample
{
public:
    explicit SpeculativeSliver(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new SpeculativeSliver(settings); }
};

static int sampleSpeculativeSliver = RegisterSample("Continuous", "Speculative Sliver", SpeculativeSliver::Create);

// This shows that while Box2D uses speculative collision, it does not lead to speculative ghost collisions at small
// distances
class SpeculativeGhost : public Sample
{
public:
    explicit SpeculativeGhost(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 1.75f};
    ...
    static Sample* Create(Settings& settings) { return new SpeculativeGhost(settings); }
};
...
{
public:
    explicit PixelImperfect(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new PixelImperfect(settings); }
...
{
public:
    explicit RestitutionThreshold(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {7.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new RestitutionThreshold(settings); }

    b2BodyId m_ballId;
};

static int sampleRestitutionThreshold =
    RegisterSample("Continuous", "Restitution Threshold", RestitutionThreshold::Create);

class Drop : public Sample
{
public:
    explicit Drop(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Drop(settings); }
...
{
public:
    explicit Pinball(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Pinball(settings); }
...
{
public:
    explicit Wedge(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Wedge(settings); }
};
