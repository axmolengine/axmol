...
public:
    ...
    explicit BenchmarkBarrel(Settings& settings) : Sample(settings)
    {
        ...
        for (int i = 0; i < m_columnCount; ++i)
        {
            ...
            for (int j = 0; j < m_rowCount; ++j)
            {
                ...
                else if (m_shapeType == e_humanShape)
                {
                    ...
                    CreateHuman(m_humans + index, m_worldId, bodyDef.position, scale, jointFriction, jointHertz,
                                jointDamping, index + 1, nullptr, false);
                }
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkBarrel(settings); }
...
{
public:
    explicit BenchmarkTumbler(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkTumbler(settings); }
};
...
{
public:
    explicit BenchmarkManyTumblers(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkManyTumblers(settings); }
...
{
public:
    explicit BenchmarkLargePyramid(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkLargePyramid(settings); }
};
...
{
public:
    explicit BenchmarkManyPyramids(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkManyPyramids(settings); }
};
...
public:
    ...
    explicit BenchmarkCreateDestroy(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 50.0f};
...
public:
    ...
    explicit BenchmarkSleep(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 50.0f};
...
{
public:
    explicit BenchmarkJointGrid(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkJointGrid(settings); }
};
...
{
public:
    explicit BenchmarkSmash(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkSmash(settings); }
};
...
{
public:
    explicit BenchmarkCompound(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkCompound(settings); }
};
...
{
public:
    explicit BenchmarkKinematic(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkKinematic(settings); }
};
...
{
public:
    explicit BenchmarkCast(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkCast(settings); }
...
{
public:
    explicit BenchmarkSpinner(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkSpinner(settings); }
};
...
{
public:
    explicit BenchmarkRain(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkRain(settings); }
};
...
{
public:
    explicit BenchmarkShapeDistance(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 0.0f};
    ...
    static Sample* Create(Settings& settings) { return new BenchmarkShapeDistance(settings); }
