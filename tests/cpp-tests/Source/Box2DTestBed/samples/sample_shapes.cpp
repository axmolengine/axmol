...
public:
    ...
    explicit ChainShape(Settings& settings) : Sample(settings)
    {
    ...
    void CreateScene()
    {
        ...
        //				   {1.90625, 30.41675},	  {5.875, 17.1875},
        //{11.16675, 25.125}, 				   {9.84375, 29.09375},	  {13.8125, 31.7395},		 {21.75, 30.41675},
        ...
        b2Vec2 points[] = {
            {-56.885498, 12.8985004},   {-56.885498, 16.2057495},   {56.885498, 16.2057495},
            {56.885498, -16.2057514},   {51.5935059, -16.2057514},  {43.6559982, -10.9139996},
            {35.7184982, -10.9139996},  {27.7809982, -10.9139996},  {21.1664963, -14.2212505},
            {11.9059982, -16.2057514},  {0, -16.2057514},           {-10.5835037, -14.8827496},
            {-17.1980019, -13.5597477}, {-21.1665001, -12.2370014}, {-25.1355019, -9.5909977},
            {-31.75, -3.63799858},      {-38.3644981, 6.2840004},   {-42.3334999, 9.59125137},
            {-47.625, 11.5755005},      {-56.885498, 12.8985004},
        };
    ...
    static Sample* Create(Settings& settings) { return new ChainShape(settings); }
...
{
public:
    explicit CompoundShapes(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new CompoundShapes(settings); }
...
public:
    ...
    explicit ShapeFilter(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_zoom   = 25.0f * 0.5f;
    ...
    static Sample* Create(Settings& settings) { return new ShapeFilter(settings); }
...
public:
    ...
    explicit CustomFilter(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new CustomFilter(settings); }
...
public:
    ...
    explicit Restitution(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Restitution(settings); }
...
{
public:
    explicit Friction(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new Friction(settings); }
};
...
{
public:
    explicit RollingResistance(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new RollingResistance(settings); }
...
{
public:
    explicit ConveyorBelt(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new ConveyorBelt(settings); }
};
...
{
public:
    explicit TangentSpeed(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
...

        {
            ...
            // const char* path = "M 613.8334,185.20833 H 500.06255 L 470.95838,182.5625 444.50004,174.625
            // 418.04171,161.39583 "
            //				   "394.2292,140.22917 h "
            //				   "-13.22916 v 44.97916 H 68.791712 V 0 h -21.16671 v 206.375 l
            //566.208398,-1e-5 z";

            const char* path =
                "m 613.8334,185.20833 -42.33338,0 h -37.04166 l -34.39581,0 -29.10417,-2.64583 -26.45834,-7.9375 "
    ...
    static Sample* Create(Settings& settings) { return new TangentSpeed(settings); }
...
{
public:
    explicit ModifyGeometry(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    void Step(Settings& settings) override { Sample::Step(settings); }

    static Sample* Create(Settings& settings) { return new ModifyGeometry(settings); }
...
// Shows how to link to chain shapes together. This is a useful technique for building large game levels with smooth
// collision.
class ChainLink : public Sample
{
public:
    explicit ChainLink(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 5.0f};
    ...
    static Sample* Create(Settings& settings) { return new ChainLink(settings); }
};
...
{
public:
    explicit RoundedShapes(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new RoundedShapes(settings); }
};
...
{
public:
    explicit EllipseShape(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_zoom   = 25.0f * 0.55f;
    ...
    static Sample* Create(Settings& settings) { return new EllipseShape(settings); }
};
...
{
public:
    explicit OffsetShapes(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_zoom   = 25.0f * 0.55f;
    ...
    static Sample* Create(Settings& settings) { return new OffsetShapes(settings); }
};
...
{
public:
    explicit Explosion(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
            g_camera.m_center = {0.0f, 0.0f};
    ...
    static Sample* Create(Settings& settings) { return new Explosion(settings); }
...
{
public:
    explicit RecreateStatic(Settings& settings) : Sample(settings)
    {
        if (settings.restart == false)
        {
    ...
    static Sample* Create(Settings& settings) { return new RecreateStatic(settings); }
