...
#include "sceneext/CSCommon_generated.h"  // flatbuffers::ResourceData, it's ok for all revision of loaders
...
static void onSetPropEndedDummy(ax::Node*) {}
...
void (*onSetPropsEnded)(ax::Node*)                                                      = onSetPropEndedDummy;
...
ax::ext::timeline::SkeletonNode* (*aSkeletonNode)();
ax::ext::timeline::BoneNode* (*aBoneNode)();
...
void resetReaderAllHooks()
{
    ...
    aSkeletonNode       = object_create_func<ax::ext::timeline::SkeletonNode>;
    aBoneNode           = object_create_func<ax::ext::timeline::BoneNode>;
