 ...
 */
class SCNIO_API ILocalizationManager
{
public:
 ...
 */
class SCNIO_API JsonLocalizationManager : ILocalizationManager
{
public:
...
class SCNIO_API BinLocalizationManager : ILocalizationManager
{
public:
    static ILocalizationManager* getInstance();
    static void destroyInstance();
...
class SCNIO_API LocalizationHelper
{
public:
