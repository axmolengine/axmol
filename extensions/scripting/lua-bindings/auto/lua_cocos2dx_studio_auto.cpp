...
int lua_cocos2dx_studio_ActionFrame_getAction(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 2) {
            ...
            object_to_luaval<axis::ActionInterval>(tolua_S, "cc.ActionInterval",(axis::ActionInterval*)ret);
            return 1;
        }
    }while(0);
    ok  = true;
...
int lua_cocos2dx_studio_ActionObject_play(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            axis::CallFunc* arg0;
            ok &= luaval_to_object<axis::CallFunc>(tolua_S, 2, "cc.CallFunc",&arg0, "ccs.ActionObject:play");
...
int lua_cocos2dx_studio_ActionManagerEx_playActionByName(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 3) {
            ...
            if (!ok) { break; }
            axis::CallFunc* arg2;
            ok &= luaval_to_object<axis::CallFunc>(tolua_S, 4, "cc.CallFunc",&arg2, "ccs.ActionManagerEx:playActionByName");
...
int lua_cocos2dx_studio_DisplayManager_addDisplay(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 2) {
            axis::Node* arg0;
            ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.DisplayManager:addDisplay");
...
int lua_cocos2dx_studio_Bone_addDisplay(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 2) {
            axis::Node* arg0;
            ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.Bone:addDisplay");
...
int lua_cocos2dx_studio_ComAttribute_createInstance(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        object_to_luaval<axis::Ref>(tolua_S, "cc.Ref",(axis::Ref*)ret);
        return 1;
    }
...
int lua_cocos2dx_studio_ComRender_setNode(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.ComRender:setNode");
        if(!ok)
        {
...
int lua_cocos2dx_studio_ComRender_create(lua_State* tolua_S)
{
    ...
    do 
    {
        ...
        {
            axis::Node* arg0;
            ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.ComRender:create");
            if (!ok) { break; }
            const char* arg1;
...
int lua_cocos2dx_studio_GUIReader_widgetFromJsonFile(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        object_to_luaval<axis::ui::Widget>(tolua_S, "ccui.Widget",(axis::ui::Widget*)ret);
        return 1;
    }
...
int lua_cocos2dx_studio_Frame_setNode(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.Frame:setNode");
        if(!ok)
        {
...
int lua_cocos2dx_studio_Timeline_setNode(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.Timeline:setNode");
        if(!ok)
        {
...
int lua_cocos2dx_studio_ActionTimelineNode_init(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.ActionTimelineNode:init");
...
int lua_cocos2dx_studio_ActionTimelineNode_setRoot(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.ActionTimelineNode:setRoot");
        if(!ok)
        {
...
int lua_cocos2dx_studio_ActionTimelineNode_create(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        axis::Node* arg0;
        cocostudio::timeline::ActionTimeline* arg1;
        ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.ActionTimelineNode:create");
...
int lua_cocos2dx_studio_BoneNode_displaySkin(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 2) {
            axis::Node* arg0;
            ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.BoneNode:displaySkin");
...
int lua_cocos2dx_studio_BoneNode_addSkin(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 3) {
            axis::Node* arg0;
            ok &= luaval_to_object<axis::Node>(tolua_S, 2, "cc.Node",&arg0, "ccs.BoneNode:addSkin");
