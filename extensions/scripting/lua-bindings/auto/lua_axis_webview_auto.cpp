...
int lua_axis_webview_WebView_setOpacityWebView(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_setOpacityWebView'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_canGoBack(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_canGoBack'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_loadHTMLString(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_loadHTMLString'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_goForward(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_goForward'", nullptr);
            return 0;
        }
        cobj->goForward();
        lua_settop(tolua_S, 1);
...
int lua_axis_webview_WebView_goBack(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_goBack'", nullptr);
            return 0;
        }
        cobj->goBack();
        lua_settop(tolua_S, 1);
...
int lua_axis_webview_WebView_setScalesPageToFit(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_setScalesPageToFit'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_loadFile(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_loadFile'", nullptr);
            return 0;
        }
        cobj->loadFile(arg0);
        lua_settop(tolua_S, 1);
...
int lua_axis_webview_WebView_setBounces(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_setBounces'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_evaluateJS(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_evaluateJS'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_setBackgroundTransparent(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_setBackgroundTransparent'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_canGoForward(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_canGoForward'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_stopLoading(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_stopLoading'", nullptr);
            return 0;
        }
        cobj->stopLoading();
        lua_settop(tolua_S, 1);
...
int lua_axis_webview_WebView_getOpacityWebView(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_getOpacityWebView'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_reload(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_reload'", nullptr);
            return 0;
        }
        cobj->reload();
        lua_settop(tolua_S, 1);
...
int lua_axis_webview_WebView_setJavascriptInterfaceScheme(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_webview_WebView_setJavascriptInterfaceScheme'", nullptr);
            return 0;
        }
...
int lua_axis_webview_WebView_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
static int lua_axis_webview_WebView_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (WebView)");
    return 0;
}

int lua_register_axis_webview_WebView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"WebView");
        tolua_function(tolua_S,"new",lua_axis_webview_WebView_constructor);
        tolua_function(tolua_S,"setOpacityWebView",lua_axis_webview_WebView_setOpacityWebView);
        tolua_function(tolua_S,"canGoBack",lua_axis_webview_WebView_canGoBack);
        tolua_function(tolua_S,"loadHTMLString",lua_axis_webview_WebView_loadHTMLString);
        tolua_function(tolua_S,"goForward",lua_axis_webview_WebView_goForward);
        tolua_function(tolua_S,"goBack",lua_axis_webview_WebView_goBack);
        tolua_function(tolua_S,"setScalesPageToFit",lua_axis_webview_WebView_setScalesPageToFit);
        tolua_function(tolua_S,"loadFile",lua_axis_webview_WebView_loadFile);
        tolua_function(tolua_S,"loadURL",lua_axis_webview_WebView_loadURL);
        tolua_function(tolua_S,"setBounces",lua_axis_webview_WebView_setBounces);
        tolua_function(tolua_S,"evaluateJS",lua_axis_webview_WebView_evaluateJS);
        tolua_function(tolua_S,"setBackgroundTransparent",lua_axis_webview_WebView_setBackgroundTransparent);
        tolua_function(tolua_S,"getOnJSCallback",lua_axis_webview_WebView_getOnJSCallback);
        tolua_function(tolua_S,"canGoForward",lua_axis_webview_WebView_canGoForward);
        tolua_function(tolua_S,"stopLoading",lua_axis_webview_WebView_stopLoading);
        tolua_function(tolua_S,"getOpacityWebView",lua_axis_webview_WebView_getOpacityWebView);
        tolua_function(tolua_S,"reload",lua_axis_webview_WebView_reload);
...
TOLUA_API int register_all_axis_webview(lua_State* tolua_S)
{
	tolua_open(tolua_S);
	...
	lua_register_axis_webview_WebView(tolua_S);
