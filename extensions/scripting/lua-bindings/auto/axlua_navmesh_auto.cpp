...
{
    AXLOGD("luabindings: finalizing LUA object (NavMeshAgent)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (NavMeshObstacle)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (NavMesh)");
    return 0;
}
