...
int lua_ax_physics_PhysicsCollider_setTag(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsCollider:setTag");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_setCategoryBitmask(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsCollider:setCategoryBitmask");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_setContactTestBitmask(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsCollider:setContactTestBitmask");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_setCollisionBitmask(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsCollider:setCollisionBitmask");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_setGroup(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsCollider:setGroup");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_recenterPoints(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ax.PhysicsCollider:recenterPoints");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsCollider_getPolygonCenter(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ax.PhysicsCollider:getPolygonCenter");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsColliderPolygon_getPoint(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsColliderPolygon:getPoint");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsColliderPolygon_create(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ax.PhysicsColliderPolygon:create");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsColliderPolygon_calculateArea(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ax.PhysicsColliderPolygon:calculateArea");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsColliderEdgePolygon_create(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ax.PhysicsColliderEdgePolygon:create");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsColliderEdgeChain_create(lua_State* tolua_S)
{
    ...
    if (argc == 3)
    {
        ...
        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ax.PhysicsColliderEdgeChain:create");
        if(!ok)
        {
...
int lua_ax_physics_PhysicsBody_removeCollider(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            int arg0;
            ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsBody:removeCollider");
...
int lua_ax_physics_PhysicsBody_getCollider(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ax.PhysicsBody:getCollider");
        if(!ok)
        {
