...
int lua_cocos2dx_spine_SkeletonRenderer_initWithSkeleton(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_initWithSkeleton'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonRenderer_initWithSkeleton'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_initWithSkeleton'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonRenderer_createWithSkeleton(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_createWithSkeleton'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_spine_SkeletonRenderer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonRenderer");
        ...
        tolua_function(tolua_S,"initWithSkeleton",lua_cocos2dx_spine_SkeletonRenderer_initWithSkeleton);
...
int lua_cocos2dx_spine_SkeletonAnimation_setPostUpdateWorldTransformsListener(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setPostUpdateWorldTransformsListener'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setPostUpdateWorldTransformsListener'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setPostUpdateWorldTransformsListener'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_setPreUpdateWorldTransformsListener(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setPreUpdateWorldTransformsListener'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setPreUpdateWorldTransformsListener'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setPreUpdateWorldTransformsListener'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonAnimation");
        ...
        tolua_function(tolua_S,"setPostUpdateWorldTransformsListener",lua_cocos2dx_spine_SkeletonAnimation_setPostUpdateWorldTransformsListener);
        ...
        tolua_function(tolua_S,"setPreUpdateWorldTransformsListener",lua_cocos2dx_spine_SkeletonAnimation_setPreUpdateWorldTransformsListener);
