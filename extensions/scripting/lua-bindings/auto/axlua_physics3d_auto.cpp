...
int lua_ax_physics3d_Rigidbody3D_getPersistedContacts(lua_State* tolua_S)
{
    int argc = 0;
    ax::Rigidbody3D* obj = nullptr;
    bool ok  = true;
    ...
    if (!obj)
    {
        tolua_error(tolua_S,"invalid 'obj' in function 'lua_ax_physics3d_Rigidbody3D_getPersistedContacts'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_ax_physics3d_Rigidbody3D_getPersistedContacts'", nullptr);
            return 0;
        }
        auto&& ret = obj->getPersistedContacts();
        contact_info_3d_span_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ax.Rigidbody3D:getPersistedContacts",argc, 0);
    return 0;

#if _AX_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_ax_physics3d_Rigidbody3D_getPersistedContacts'.",&tolua_err);
#endif
...
int lua_register_ax_physics3d_Rigidbody3D(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Rigidbody3D");
        ...
        tolua_function(tolua_S,"getPersistedContacts",lua_ax_physics3d_Rigidbody3D_getPersistedContacts);
