...
int lua_cocos2dx_controller_Controller_getControllerByDeviceId(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        object_to_luaval<axis::Controller>(tolua_S, "cc.Controller",(axis::Controller*)ret);
        return 1;
    }
...
int lua_cocos2dx_controller_EventController_constructor(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 3) {
            ...
            ok &= luaval_to_object<axis::Controller>(tolua_S, 3, "cc.Controller",&arg1, "cc.EventController:EventController");
...
int lua_cocos2dx_controller_EventListenerController_create(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        object_to_luaval<axis::EventListenerController>(tolua_S, "cc.EventListenerController",(axis::EventListenerController*)ret);
        return 1;
    }
