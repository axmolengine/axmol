...
{
    AXLOGD("luabindings: finalizing LUA object (Controller)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (EventController)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (EventListenerController)");
    return 0;
}
