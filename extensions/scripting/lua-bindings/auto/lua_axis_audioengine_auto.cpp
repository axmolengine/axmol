...
int lua_axis_audioengine_AudioEngine_play2d(lua_State* tolua_S)
{
    ...
    if (argc == 4)
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "ax.AudioEngine:play2d");
        ok &= luaval_to_number(tolua_S, 4,&arg2, "ax.AudioEngine:play2d");
        ok &= luaval_to_object<const axis::AudioProfile>(tolua_S, 5, "ax.AudioProfile",&arg3, "ax.AudioEngine:play2d");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_axis_audioengine_AudioEngine_play2d'", nullptr);
            return 0;
...
int lua_axis_audioengine_AudioEngine_getDefaultProfile(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        object_to_luaval<axis::AudioProfile>(tolua_S, "ax.AudioProfile",(axis::AudioProfile*)ret);
        return 1;
    }
