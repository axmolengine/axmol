...
int lua_ax_3d_Animation3D_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Animation3D");
...
int lua_ax_3d_Animate3D_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Animate3D");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_TextureCube_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.TextureCube");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_AttachNode_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.AttachNode");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_BillBoard_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.BillBoard");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_Mesh_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        cobj = new ax::Mesh();
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Mesh");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ax.Mesh:Mesh",argc, 0);
...
int lua_ax_3d_Skeleton3D_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Skeleton3D");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_Skybox_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        cobj = new ax::Skybox();
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Skybox");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
int lua_ax_3d_Terrain_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        cobj = new ax::Terrain();
        tolua_pushusertype(tolua_S,(void*)cobj,"ax.Terrain");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
