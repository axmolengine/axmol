...
{
    AXLOGD("luabindings: finalizing LUA object (Program)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (VertexLayout)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (ProgramState)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (TextureBackend)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (Texture2DBackend)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (TextureCubemapBackend)");
    return 0;
}
...
{
    AXLOGD("luabindings: finalizing LUA object (DriverBase)");
    return 0;
}
