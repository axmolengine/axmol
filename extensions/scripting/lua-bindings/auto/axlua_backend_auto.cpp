...
int lua_register_ax_backend_PixelFormat(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PixelFormat");
        ...
        // tolua_constant(tolua_S, "ASTC5x4", /* reserved, no ID */);
        tolua_constant(tolua_S, "ASTC5x5", 14);
        // tolua_constant(tolua_S, "ASTC6x5", /* reserved, no ID */);
        ...
        // tolua_constant(tolua_S, "ASTC10x6",  /* reserved, no ID */);
        // tolua_constant(tolua_S, "ASTC10x8",  /* reserved, no ID */);
        // tolua_constant(tolua_S, "ASTC10x10", /* reserved, no ID */);
        // tolua_constant(tolua_S, "ASTC12x10", /* reserved, no ID */);
        // tolua_constant(tolua_S, "ASTC12x12", /* reserved, no ID */);
