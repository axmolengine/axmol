...
int lua_cocos2dx_extension_AssetsManager_create(lua_State* tolua_S)
{
    ...
    if (argc == 6)
    {
        ...
        object_to_luaval<axis::extension::AssetsManager>(tolua_S, "cc.AssetsManager",(axis::extension::AssetsManager*)ret);
        return 1;
    }
...
int lua_cocos2dx_extension_EventAssetsManagerEx_getAssetsManagerEx(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<axis::extension::AssetsManagerEx>(tolua_S, "cc.AssetsManagerEx",(axis::extension::AssetsManagerEx*)ret);
        return 1;
    }
...
int lua_cocos2dx_extension_EventAssetsManagerEx_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_object<axis::extension::AssetsManagerEx>(tolua_S, 3, "cc.AssetsManagerEx",&arg1, "cc.EventAssetsManagerEx:EventAssetsManagerEx");
...
int lua_cocos2dx_extension_AssetsManagerEx_getLocalManifest(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<axis::extension::Manifest>(tolua_S, "cc.Manifest",(axis::extension::Manifest*)ret);
        return 1;
    }
...
int lua_cocos2dx_extension_EventListenerAssetsManagerEx_init(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<const axis::extension::AssetsManagerEx>(tolua_S, 2, "cc.AssetsManagerEx",&arg0, "cc.EventListenerAssetsManagerEx:init");
...
int lua_cocos2dx_extension_ParticleSystem3D_addAffector(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Particle3DAffector>(tolua_S, 2, "cc.Particle3DAffector",&arg0, "cc.ParticleSystem3D:addAffector");
        if(!ok)
        {
...
int lua_cocos2dx_extension_ParticleSystem3D_getRender(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<axis::Particle3DRender>(tolua_S, "cc.Particle3DRender",(axis::Particle3DRender*)ret);
        return 1;
    }
...
int lua_cocos2dx_extension_ParticleSystem3D_setEmitter(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Particle3DEmitter>(tolua_S, 2, "cc.Particle3DEmitter",&arg0, "cc.ParticleSystem3D:setEmitter");
        if(!ok)
        {
...
int lua_cocos2dx_extension_ParticleSystem3D_setRender(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::Particle3DRender>(tolua_S, 2, "cc.Particle3DRender",&arg0, "cc.ParticleSystem3D:setRender");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_forceEmission(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<axis::PUEmitter>(tolua_S, 2, "cc.PUEmitter",&arg0, "cc.PUParticleSystem3D:forceEmission");
...
int lua_cocos2dx_extension_PUParticleSystem3D_addListener(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUListener>(tolua_S, 2, "cc.PUListener",&arg0, "cc.PUParticleSystem3D:addListener");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_clone(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<axis::PUParticleSystem3D>(tolua_S, "cc.PUParticleSystem3D",(axis::PUParticleSystem3D*)ret);
        return 1;
    }
...
int lua_cocos2dx_extension_PUParticleSystem3D_addEmitter(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUEmitter>(tolua_S, 2, "cc.PUEmitter",&arg0, "cc.PUParticleSystem3D:addEmitter");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_addBehaviourTemplate(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUBehaviour>(tolua_S, 2, "cc.PUBehaviour",&arg0, "cc.PUParticleSystem3D:addBehaviourTemplate");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_copyAttributesTo(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUParticleSystem3D>(tolua_S, 2, "cc.PUParticleSystem3D",&arg0, "cc.PUParticleSystem3D:copyAttributesTo");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_removeListener(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUListener>(tolua_S, 2, "cc.PUListener",&arg0, "cc.PUParticleSystem3D:removeListener");
        if(!ok)
        {
...
int lua_cocos2dx_extension_PUParticleSystem3D_addObserver(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<axis::PUObserver>(tolua_S, 2, "cc.PUObserver",&arg0, "cc.PUParticleSystem3D:addObserver");
        if(!ok)
        {
