...
ax.RED = ax.color(255,0,0)
ax.GREEN = ax.color(0,255,0)
ax.BLUE = ax.color(0,0,255)
ax.BLACK = ax.color(0,0,0)
ax.WHITE = ax.color(255,255,255)
ax.YELLOW = ax.color(255,255,0)
