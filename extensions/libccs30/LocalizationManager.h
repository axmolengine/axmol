...
namespace cocostudio {
    ...
    */
    class CCS_LDR_DLL ILocalizationManager
    {
    public:
    ...
    */
    class CCS_LDR_DLL JsonLocalizationManager : ILocalizationManager
    {
    public:
    ...
    class CCS_LDR_DLL BinLocalizationManager : ILocalizationManager
    {
    public:
        static ILocalizationManager* getInstance();
        static void destroyInstance();
    ...
    class CCS_LDR_DLL LocalizationHelper
    {
    public:
