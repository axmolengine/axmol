...
{
    ImGuiFreeTypeLoaderFlags_NoHinting = 1 << 0,   // Disable hinting. This generally generates 'blurrier' bitmap glyphs
...
// = ImGuiFreeType::GetBuilderForFreeType()' to 'io.Fonts->SetFontLoader(ImGuiFreeType::GetFontLoader())' if you need
// runtime selection. static inline bool BuildFontAtlas(ImFontAtlas* atlas, unsigned int flags = 0) {
// atlas->FontBuilderIO = GetBuilderForFreeType(); atlas->FontLoaderFlags = flags; return atlas->Build(); } // Prefer
