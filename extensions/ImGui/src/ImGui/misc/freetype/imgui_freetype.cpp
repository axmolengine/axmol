...
bool ImGui_ImplFreeType_FontSrcData::InitFont(FT_Library ft_library,
                                              ImFontConfig* src,
                                              ImGuiFreeTypeLoaderFlags extra_font_loader_flags)
{
    FT_Error error = FT_New_Memory_Face(ft_library, (uint8_t*)src->FontData, (FT_Long)src->FontDataSize,
...
bool ImGui_ImplFreeType_FontBakedInit(ImFontAtlas* atlas,
                                      ImFontConfig* src,
                                      ImFontBaked* baked,
...
void ImGui_ImplFreeType_FontBakedDestroy(ImFontAtlas* atlas,
                                         ImFontConfig* src,
                                         ImFontBaked* baked,
                                         void* loader_data_for_baked_src)
{
...
bool ImGui_ImplFreeType_FontBakedLoadGlyph(ImFontAtlas* atlas,
                                           ImFontConfig* src,
                                           ImFontBaked* baked,
                                           void* loader_data_for_baked_src,
                                           ImWchar codepoint,
                                           ...
                                           float* out_advance_x)
{
    ...
    FT_Render_Mode render_mode =
        (bd_font_data->UserFlags & ImGuiFreeTypeLoaderFlags_Monochrome) ? FT_RENDER_MODE_MONO : FT_RENDER_MODE_NORMAL;
