...
function (ax_add_delay_load_options target)
    ...
    if(FUZZ_MSVC)
        set(delay_load_options "/DELAYLOAD:mf.dll" "/DELAYLOAD:mfplat.dll")
        target_link_options(${target} PRIVATE ${delay_load_options})
    else()
        set(delay_load_options "-Xlinker /DELAYLOAD:mf.dll -Xlinker /DELAYLOAD:mfplat.dll")
        set_property(TARGET ${target} APPEND_STRING PROPERTY LINK_FLAGS " ${delay_load_options}")
    endif()
...
function(ax_setup_app_config app_name)
    ...
    elseif(WINDOWS)
        ...
        set_property(TARGET ${app_name} APPEND_STRING PROPERTY LINK_FLAGS " ${_win32_linker_flags}")
