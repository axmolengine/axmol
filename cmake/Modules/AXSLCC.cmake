  ...
  if(AX_ENABLE_GL)
    if(AX_GLES_PROFILE)
      if(AX_GLES_PROFILE GREATER_EQUAL 300)
        list(APPEND TARGET_LIST "gles-300")
      else()
        list(APPEND TARGET_LIST "gles-100")
      endif()
    else()
      list(APPEND TARGET_LIST "glsl-330")
    endif()
  endif()
  if(AX_ENABLE_D3D11)
    list(APPEND TARGET_LIST "hlsl-50")
  endif()
  if(AX_ENABLE_D3D12)
    list(APPEND TARGET_LIST "hlsl-51")
  endif()
  if(AX_ENABLE_MTL)
    list(APPEND TARGET_LIST "msl-20000")
  endif()
  if(AX_ENABLE_VK)
    list(APPEND TARGET_LIST "spirv-100")
  endif()
  if(NOT TARGET_LIST)
